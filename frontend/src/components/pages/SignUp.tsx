...
const SignUp = observer(() => {
    ...
    const handleClick = (): void => {
        UserStore.register(values.name, values.userName, values.password)
    }
        ...
        <Container maxWidth="sm" sx={{
            ...
            <Box sx={styleBox}>
                ...
                <Box sx={{
                    ...
                    <Button sx={{ m: 1, width: '25ch' }} onClick={() => handleClick()} color="success" variant="contained">Sign up</Button>
